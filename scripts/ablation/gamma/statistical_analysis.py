    ...
    for dataset_stats in dataset_names:
        ...
        for method in results:
            ...
            for example in rank_list:
                ...
                methods.append(method + '_' + str(example['gamma']))
        ...
        val, p = friedmanchisquare(all_accuracies[0], all_accuracies[1], all_accuracies[2], all_accuracies[3])
        val2, p2 = wilcoxon(all_accuracies[0], all_accuracies[3])
        val3, p3 = friedmanchisquare(all_accuracies[1], all_accuracies[2], all_accuracies[3])
        val4, p4 = wilcoxon(all_accuracies[2], all_accuracies[3])
        print('FRIEDMAN 1,2,3,4 : ', p)
        print('WILCOXON 1,4 : ', p2)
        print('FRIEDMAN 2,3,4 : ', p3)
        print('WILCOXON 3,4 : ', p4)
