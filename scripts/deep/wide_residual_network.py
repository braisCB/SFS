...
def residual_block(ip, output_channels, strides=(1, 1), dropout=0.0, regularization=0.0, kernel_initializer='he_normal'):
...
def wrn_block(ip, output_channels, N, strides=(1, 1), dropout=0.0, regularization=0.0, kernel_initializer='he_normal'):
    m = residual_block(
        ip, output_channels, strides, dropout, regularization=regularization, kernel_initializer=kernel_initializer
    )
    for i in range(N-1):
        m = residual_block(
            m, output_channels, dropout=dropout, regularization=regularization, kernel_initializer=kernel_initializer
        )
    return m
